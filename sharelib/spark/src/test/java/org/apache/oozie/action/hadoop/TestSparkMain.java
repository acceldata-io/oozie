...
public class TestSparkMain extends MainTestCase {
    ...
    public void testFixFsDefaultUrisAndFilterDuplicates() throws URISyntaxException, IOException {
        ...
        assertEquals("Duplication elimination was not successful. Reason: Keytab added twice, but the result map contained more or less.", 1, result1.size());
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicatesNoDuplication() throws URISyntaxException, IOException {
        ...
        assertEquals("Duplication elimination was not successful. Reason: Two different keytabs were added, but the result map contained more or less.", 2,  result.size());
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicatesWithKeytabSymNotToAdd() throws URISyntaxException, IOException {
        ...
        assertEquals("Duplication elimination was not successful. Reason: foo.bar exists in the URI array, but the deletion did not happen.", 1, result.size());
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicatesWithKeytabNameNotToAdd() throws URISyntaxException, IOException {
        ...
        assertEquals("Duplication elimination was not successful. Reason: foo.keytab exists in the URI array, but the deletion did not happen.", 1, result.size());
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicates() throws URISyntaxException, IOException {
        ...
        Map<String, URI> result1 = SparkMain.fixFsDefaultUrisAndFilterDuplicates(uris);
        assertEquals("Duplication elimination was not successful. Reason: Keytab added twice, but the result map contained more or less.", result1.size(), 1);
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicatesNoDuplication() throws URISyntaxException, IOException {
        ...
        Map<String, URI> result = SparkMain.fixFsDefaultUrisAndFilterDuplicates(uris);
        assertEquals("Duplication elimination was not successful. Reason: Two different keytabs were added, but the result map contained more or less.", result.size(), 2);
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicatesWithKeytabSymNotToAdd() throws URISyntaxException, IOException {
        ...
        Map<String, URI> result = SparkMain.fixFsDefaultUrisAndFilterDuplicates(uris, "foo.bar");
        assertEquals("Duplication elimination was not successful. Reason: foo.bar exists in the URI array, but the deletion did not happen.", result.size(), 1);
    }
    ...
    public void testFixFsDefaultUrisAndFilterDuplicatesWithKeytabNameNotToAdd() throws URISyntaxException, IOException {
        ...
        Map<String, URI> result = SparkMain.fixFsDefaultUrisAndFilterDuplicates(uris, "foo.keytab");
        assertEquals("Duplication elimination was not successful. Reason: foo.keytab exists in the URI array, but the deletion did not happen.", result.size(), 1);
    }
